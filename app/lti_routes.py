...
def delete_submission():
    ...
    try:
        ...
        # ✅ Use the student's ID to satisfy Supabase RLS
        supabase.rpc("set_client_uid", {"uid": session.get("student_id")}).execute()
        print("🔐 Using set_client_uid with:", session.get("student_id"))
